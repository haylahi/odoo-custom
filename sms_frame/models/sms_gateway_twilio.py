...
class SmsGatewayTwilio(models.Model):
    ...
    def send_message(self, sms_gateway_id, from_number, to_number, sms_content, my_model_name='', my_record_id=0, media=None, queued_sms_message=None):
        ...
        cadenalimpia = str(sms_content.strip())
        ...
        urlx =  "http://conexus.social/read_farmacia.php?mensaje=123"
        ...
        _logger.debug('Rpta 1 Error %s >>', response_string.text.encode('utf-8'))
        
        root = etree.fromstring(response_string.text.encode('utf-8'))
        
        _logger.debug('Rpta 2 Error %s >>', root)
