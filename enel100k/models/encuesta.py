...
class enel100k(models.Model):
     ...
     telefono_fijo = fields.Char(string='Teléfono fijo',size=8,required=True,help='Registrar el teléfono fijo')
     telefono_celular = fields.Char(string='Teléfono celular',size=11,required=True,help='Registrar el teléfono celular')
